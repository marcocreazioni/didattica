...
if (!$connessione) {
  ...
  /* $visualizzadati = "SELECT ID , NOME, COGNOME, EMAIL, TELEFONO FROM clienti"; */
  /* Selezionare dei campi dei clienti e ordinati per ORDER BY e messi in ordina alfabeti ascendente con ASH e discendente con DESH*/
